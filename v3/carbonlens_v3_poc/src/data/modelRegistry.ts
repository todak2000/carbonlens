...
export const MODEL_REGISTRY: ModelEntry[] = [
...

  {
    ...
    shortName: 'MARS IFT (Olagunju, in prep.)',
    type: 'ml',
    status: 'active',
    citation: {
      ...
      note: 'MSc research, Universiti Teknologi PETRONAS (UTP), Malaysia. In preparation. Trained on 3,265 experimental CO\u2082-brine IFT datapoints from 16 independent laboratories across 4 continents.',
    },
