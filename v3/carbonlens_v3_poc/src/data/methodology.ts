...
export const METHODOLOGY: MethodologySection[] = [
  {
    ...
    equations: [{
      ...
      formula: '\u03c1 = \u03c1(T, P) via reduced Helmholtz energy a\u1d63(\u03c4, \u03b4)',
      params: 'T: temperature (K), P: pressure (Pa), \u03c4 = Tc/T, \u03b4 = \u03c1/\u03c1c',
      reference: 'Span & Wagner (1996) J. Phys. Chem. Ref. Data 25(6), 1509-1596',
      notes: 'Critical point: Tc = 304.1282 K, \u03c1c = 467.6 kg/m\u00b3. Accurate to \u00b10.05% for reservoir conditions.',
    }],
  },
  {
  ...
  },
  {
    ...
    equations: [{
      ...
      formula: '\u0394P = (Q\u00b7\u03bc)/(4\u03c0kh) \u00b7 E\u2081(r\u00b2\u03c6\u03bcc\u209c/4kt)',
      params: 'Q: volumetric rate (m\u00b3/s); k: permeability (m\u00b2); h: thickness (m); E\u2081: exponential integral',
      reference: 'Theis (1935) Trans. Am. Geophys. Union 16, 519-524',
      notes: 'Multi-well superposition applied for interference. Capped at 25 MPa overpressure.',
    }],
  },
  {
...
export const PROTOTYPE_SCOPE = {
  ...
  classicalComponents: [
    { property: 'CO\u2082 density', model: 'Span-Wagner (1996)', phd: false },
    { property: 'CO\u2082 viscosity', model: 'Fenghour et al. (1998)', phd: false },
    { property: 'CO\u2082 solubility', model: 'Duan-Sun (2003)', phd: true },
    { property: 'Brine density', model: 'Garcia (2001)', phd: true },
    { property: 'Pressure', model: 'Theis (1935)', phd: false },
    { property: 'Relative permeability', model: 'Brooks-Corey (1964)', phd: false },
    { property: 'Trapping', model: 'Land (1968)', phd: false },
